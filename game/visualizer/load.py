...
def load(temp):
    ...
    dis_fire.do(Repeat(CallFuncS(match_speed, 0.1)))
    ...
    dis_earthquake.do(Repeat(CallFuncS(match_speed, 0.1)))
    ...
    dis_monster.do(Repeat(CallFuncS(match_speed, 0.1)))
    ...
    for i in range(wrkr_total):
        ...
        if i < wrkr_total/5:
            ...
            sprite.do(Repeat(CallFuncS(match_speed, 0.1)))
