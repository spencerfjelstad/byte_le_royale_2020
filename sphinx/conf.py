...
# ones.
extensions = ['recommonmark', 'sphinx.ext.todo', 'sphinx.ext.githubpages', 'sphinx_markdown_tables']
...
project = 'Byte-le-Royale 2020'
copyright = '2019-2020, NDSU ACM'
author = 'NDSU ACM'
...
texinfo_documents = [
    (master_doc, 'Byte-le Royale"', 'Disaster Dispatcher',
